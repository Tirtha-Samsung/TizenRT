/****************************************************************************
 * arch/arm/src/armv7-a/up_addrenv_ustack.c
 *
...
int up_addrenv_ustackalloc(struct tcb_s *tcb, size_t stacksize)
{
  ...
  ret = up_addrenv_create_region(tcb->xcp.ustack, ARCH_STACK_NSECTS,
...
int up_addrenv_ustackfree(struct tcb_s *tcb)
{
  ...
  up_addrenv_destroy_region(tcb->xcp.ustack, ARCH_STACK_NSECTS,
