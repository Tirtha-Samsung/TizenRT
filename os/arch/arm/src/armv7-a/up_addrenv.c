/****************************************************************************
 * arch/arm/src/armv7-a/up_addrenv.c
 *
...
static int up_addrenv_initdata(uintptr_t l2table)
{
  ...
  virtptr = (uint32_t *)up_pgvaddr(l2table);
  ...
  virtptr = (uint32_t *)up_pgvaddr(paddr);
...
int up_addrenv_destroy(arch_addrenv_t *addrenv)
{
  ...
  up_addrenv_destroy_region(addrenv->heap, ARCH_SHM_NSECTS,
