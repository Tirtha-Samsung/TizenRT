...
#include <../arch/arm/src/a1x/chip.h>
#include <../arch/arm/include/a1x/chip.h>
#include <../arch/arm/src/common/up_internal.h>
...
{
  //Dummy Call
  //Don't need to take are of board dependencies since this will not be used
  return;
